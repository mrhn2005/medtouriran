...
/*-----------------------------------------------------------------------------------*/
    ...
    function widget($args, $instance) {
      ...
      $jellywp_widget = new WP_Query($jellywp_args);
        ...
        // Post list in widget>?>
<div class="page_builder_slider page_builder_slider_single_wrapper jelly_homepage_builder <?php if($small_title_widget == 1){echo 'jl_small_block_title';}else{}?>">
    ...
    <div class="header-main-slider-large builder_main_single_home_slider">
        <div class="full_width_slider_builder">
            <div class="full-slider-main-home-wrapper  <?php if(!get_theme_mod('disable_css_animation')==1){echo " appear_animation ";}else{echo " ";}?>">
