...
#mainmenu > li > a, .search_header_menu i, .menu_mobile_icons, #mainmenu>li.current-menu-item>a, .header_layout_style5_custom .jl_main_menu > .current-menu-parent > a, .header_layout_style5_custom #mainmenu > li > a, .header_layout_style5_custom #mainmenu > li > a:hover, #menu_wrapper .search_header_menu:hover i{color:<?php echo get_theme_mod('menu_text_color');?> !important;}
<?php }?>

<?php $menu_bg_color_gradient = get_theme_mod('menu_bg_color_gradient');
$menu_bg_color = get_theme_mod('menu_bg_color');
if ($menu_bg_color_gradient) {?>
.menu_wrapper,
...
background-color: <?php echo esc_attr($menu_bg_color_gradient);?> !important;
...
.box_layout_enable_front .header_magazine_box_menu .menu_wrapper_box_style,
.two_header_top_style .menu_wrapper,
.header_magazine_full_screen .menu_wrapper{ background:<?php echo esc_attr($menu_bg_color);?> !important; border-top: 0px !important; border-bottom: 0px solid #f0f0f0 !important;}
<?php }}?>
...
#menu-footer-menu li a, .footer-bottom .footer-left-copyright{font-family: <?php echo esc_attr($disto_menu_font_family);?> !important;}
#content_nav .menu_moble_slide > li a{font-size: 15px !important;}
<?php }?>

<?php if ($disto_p_font_family) {?>
.content_single_page p, .single_section_content .post_content, .single_section_content .post_content p{font-size: <?php echo esc_attr($disto_p_font_size);?> !important;}
