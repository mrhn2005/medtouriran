...
if ( !function_exists( 'disto_image_size' ) ) {
    ...
    add_image_size('disto_slider_grid_large', 1000, 520, false);
    ...
    add_image_size('disto_carousel_smalls', 380, 500, true);
}
...
register_sidebar(array(
        'name' => esc_attr__('Header sidebar', 'disto'),
        'id' => 'banner-sidebar',
        'before_widget' => '',
        'after_widget' => "",
        'before_title' => '<div class="widget-title"><h2>',
...
function disto_fonts() {
    ...
    $title_style_text = get_theme_mod('title_font_style');
    $paragrap_style_text = get_theme_mod('paragrap_font_style');
    if ($menu_font_style != '') {$menu_font_style = get_theme_mod('menu_font_style');}else{$menu_font_style = 'Poppins';}
    if ($title_style_text != '') {$title_style_text = get_theme_mod('title_font_style');}else{$title_style_text = 'Poppins';}
    if ($paragrap_style_text != '') {$paragrap_style_text = get_theme_mod('paragrap_font_style');}else{$paragrap_style_text = 'Poppins';}
    $subsets  = 'latin,latin-ext,cyrillic,cyrillic-ext,greek,greek-ext,vietnamese';  
    $google_font = add_query_arg( array(
            'family' => urlencode ( $title_style_text . ':100,200,300,400,500,600,700,800,900,400italic,700italic,900italic|' . $paragrap_style_text . ':100,200,300,400,500,600,700,800,900,400italic,700italic,900italic|' . $menu_font_style . ':100,200,300,400,500,600,700,800,900,400italic,700italic,900italic'),
...
function disto_font_scripts() {
    wp_enqueue_style( 'disto_fonts_url', disto_fonts(), array(), '1.1' );
}
...
function disto_load_css() {
		wp_enqueue_style( 'bootstrap', get_template_directory_uri().'/css/bootstrap.css', false, '1.1' ); 
		wp_enqueue_style( 'disto_style', get_template_directory_uri().'/style.css', false, '1.1' );
		wp_enqueue_style( 'disto_responsive', get_template_directory_uri().'/css/responsive.css', false, '1.1' ); 
...
function disto_enqueue_script() {
	wp_enqueue_script( 'fluidvids', get_template_directory_uri().'/js/fluidvids.js', array('jquery'), '1.1', true );
    wp_enqueue_script( 'infinitescroll', get_template_directory_uri().'/js/infinitescroll.js', array('jquery'), '1.1', true );
    wp_enqueue_script( 'justified', get_template_directory_uri().'/js/justified.js', array('jquery'), '1.1', true );
    wp_enqueue_script( 'slick', get_template_directory_uri().'/js/slick.js', array('jquery'), '1.1', true );
    wp_enqueue_script( 'theia-sticky-sidebar', get_template_directory_uri().'/js/theia-sticky-sidebar.js', array('jquery'), '1.1', true );
    wp_enqueue_script('masonry');
	wp_enqueue_script( 'disto-custom', get_template_directory_uri().'/js/custom.js', array('jquery'), '1.1', true );	    
}
