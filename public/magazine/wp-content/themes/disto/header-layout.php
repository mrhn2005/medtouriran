            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="jl_top_bar_right">
                        <span class="jl_current_title"><?php echo esc_attr(get_theme_mod('jl_date_title'));?></span><?php echo date_i18n( 'l ,  j  F Y', current_time( 'timestamp' ) ); ?>
                    </div>
                    <?php }?>
                </div>
            </div>
        ...
        <div class="logo_small_wrapper_table">
            <div class="logo_small_wrapper">
                <a class="logo_link" href="<?php echo esc_url(home_url('/')); ?>">
                    ...
                    <?php else: ?>
                    <img class="logo_black" src="<?php echo esc_url(get_template_directory_uri().'/img/logo.png'); ?>" alt="<?php bloginfo('description'); ?>" />
                    <?php endif; ?>
                </a>
            </div>
        </div>
                    ...
                    <div class="logo_position_wrapper">
                        <div class="logo_position_table">
                            ...
                            <a class="logo_link" href="<?php echo esc_url(home_url('/')); ?>">
                                ...
                                <img src="<?php echo esc_url($logo); ?>" alt="<?php bloginfo('description'); ?>" />
                                <?php else: ?>
                                <img class="logo_black" src="<?php echo esc_url(get_template_directory_uri().'/img/logo_w.png'); ?>" alt="<?php bloginfo('description'); ?>" />
                                <?php endif; ?>
                            </a>
                            <!-- end logo -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php if(get_theme_mod('jl_disable_c_date')){}else{?>
                    <div class="jl_top_bar_right">
                        <span class="jl_current_title"><?php echo get_theme_mod('jl_date_title');?></span><?php echo strftime("%e %B, %Y");?>
                    </div>
                    <?php }?>
                </div>
            </div>
