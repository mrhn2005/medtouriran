...
?>
	...
	<tr class="form-field">
		...
		<td>
			...
			<div class="category_style_item_image"><input type="radio" name="disto_cat_infinite" id="disto_cat_infinite-1" value="cb-off" class="radio" checked><label for="disto_cat_infinite-1"><img src="<?php echo esc_url(get_stylesheet_directory_uri().'/inc/metabox/category_asset/images/pagination1.png'); ?>"/></label></div>
			<div class="category_style_item_image"><input type="radio" name="disto_cat_infinite" id="disto_cat_infinite-2" value="infinite-scroll" class="radio"><label for="disto_cat_infinite-2"><img src="<?php echo esc_url(get_stylesheet_directory_uri().'/inc/metabox/category_asset/images/pagination2.png'); ?>"/></label></div>
			<div class="category_style_item_image"><input type="radio" name="disto_cat_infinite" id="disto_cat_infinite-3" value="infinite-load" class="radio"><label for="disto_cat_infinite-3"><img src="<?php echo esc_url(get_stylesheet_directory_uri().'/inc/metabox/category_asset/images/pagination3.png'); ?>"/></label></div>
			</div>
		</td>
	</tr>
	<?php
...
function disto_edit_category_settings( $term, $taxonomy ) {
	...
	<tr class="form-field">
        <th valign="top" scope="row">
            <label for="category-text"><?php esc_html_e( 'Category Color', 'disto' ); ?></label>
        </th>
        <td>
	...
	<tr class="form-field">
		<th scope="row" valign="top"><label><?php esc_html_e( 'Pagination Style', 'disto' ); ?></label></th>
		<td>
			<div class="category_style_item_image_wrapper">
			<div class="category_style_item_image"><input type="radio" name="disto_cat_infinite" id="disto_listing_style-1" value="cb-off" class="radio" <?php if($disto_cat_infinite === 'cb-off'){ echo 'checked="checked"'; } ?>><label for="disto_listing_style-1"><img src="<?php echo esc_url(get_stylesheet_directory_uri().'/inc/metabox/category_asset/images/pagination1.png'); ?>"/></label></div>
			<div class="category_style_item_image"><input type="radio" name="disto_cat_infinite" id="disto_listing_style-2" value="infinite-scroll" class="radio" <?php if($disto_cat_infinite === 'infinite-scroll'){ echo 'checked="checked"'; } ?>><label for="disto_listing_style-2"><img src="<?php echo esc_url(get_stylesheet_directory_uri().'/inc/metabox/category_asset/images/pagination2.png'); ?>"/></label></div>
			<div class="category_style_item_image"><input type="radio" name="disto_cat_infinite" id="disto_listing_style-3" value="infinite-load" class="radio" <?php if($disto_cat_infinite === 'infinite-load'){ echo 'checked="checked"'; } ?>><label for="disto_listing_style-3"><img src="<?php echo esc_url(get_stylesheet_directory_uri().'/inc/metabox/category_asset/images/pagination3.png'); ?>"/></label></div>
			</div>
		</td>
	</tr>
	<?php
